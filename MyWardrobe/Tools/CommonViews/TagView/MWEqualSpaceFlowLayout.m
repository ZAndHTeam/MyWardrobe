...
@interface MWEqualSpaceFlowLayout ()
{
    //内容大小
    CGSize _contentSize;
}
...
@implementation MWEqualSpaceFlowLayout
...
// 1.布局cell的
- (void)prepareLayout {
    self.delegate = (id<MWEqualSpaceFlowLayoutDelegate>)self.collectionView.delegate;
